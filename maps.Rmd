...
brazil = tm_shape(brazil_map) +
  ...
  tm_layout(bg.color = "grey70", title="Brazil", title.position = c("LEFT", "TOP"))

rio2 = tm_shape(brazil_map, bbox = st_bbox(rio_map)) +
  tm_fill(col="wheat") +
  tm_borders() +
  tm_shape(rio_map) +
  tm_fill(col="tomato1") +
  ...
  tm_layout(bg.color = "grey70", title="Rio de Janeiro State", title.position = c("LEFT", "TOP"))
